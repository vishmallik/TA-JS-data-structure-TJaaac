...
students.studentName = `Visawjeet Mallik`;
...
//yes we can defines a key of 'let or var' in any object since the key ame will be taken as string so let will be "let" and var will be "var"
